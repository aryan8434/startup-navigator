        ...
        <section className="relative pt-24 pb-20 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <div className="inline-flex items-center space-x-2 px-3 py-1.5 rounded-full bg-slate-900 border border-slate-800/80 mb-8 animate-fade-in">
              ...
              <span className="text-xs font-semibold text-indigo-400 tracking-wide uppercase">Your Growth Playbook Awaits</span>
            </div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-extrabold text-white leading-tight tracking-tight max-w-4xl mx-auto">
              Navigate the Complexity of <span className="text-gradient">Building Your Startup</span>
            </h1>

            {/* Sub-headline */}
            <p className="mt-6 text-base sm:text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
              Unlock professional guides, download legal templates, and leverage our Retrieval-Augmented AI assistant to search verified local files.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {features.map((feature, i) => {
                ...
                return (
                  ...
                  >
                    <div className={`p-3 w-fit rounded-xl bg-slate-900 border border-slate-800/80 mb-5 ${feature.color}`}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="p-6 rounded-2xl glassmorphism bg-slate-900/10 text-center border border-slate-800/50">
                <p className="text-xs font-semibold text-indigo-400 uppercase tracking-wider">Guides</p>
              ...
              {/* Stat Card 2 */}
              <div className="p-6 rounded-2xl glassmorphism bg-slate-900/10 text-center border border-slate-800/50">
                <p className="text-xs font-semibold text-emerald-400 uppercase tracking-wider">Resources</p>
                <h3 className="mt-2 text-3xl sm:text-4xl font-extrabold text-white">
              ...
              {/* Stat Card 3 */}
              <div className="p-6 rounded-2xl glassmorphism bg-slate-900/10 text-center border border-slate-800/50">
                <p className="text-xs font-semibold text-pink-400 uppercase tracking-wider">AI Queries</p>
                <h3 className="mt-2 text-3xl sm:text-4xl font-extrabold text-white">
                  {loading ? "..." : stats?.totalSearches || 0}
                </h3>
                <p className="mt-1 text-xs text-slate-500">RAG searches resolved</p>
              </div>

              {/* Stat Card 4 */}
              <div className="p-6 rounded-2xl glassmorphism bg-slate-900/10 text-center border border-slate-800/50">
                <p className="text-xs font-semibold text-amber-400 uppercase tracking-wider">Platform Status</p>
        ...
        <section className="py-16 border-t border-slate-900 bg-slate-950/20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-12 gap-4">
              <div>
                ...
                <p className="text-sm text-slate-400 mt-1">
                  Read comprehensive documentation compiled by industry specialists and legal professionals.
                </p>
              </div>
              <Link 
                href="/explore" 
            ...
            {loading ? (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[1, 2, 3].map((n) => (
                  <div key={n} className="h-64 rounded-2xl bg-slate-900/30 border border-slate-800/50 animate-pulse"></div>
                ))}
              </div>
              ...
              <p className="text-center text-slate-500 py-12">No articles found in the database. Seeding may be running...</p>
            )}
          </div>
        </section>
      </main>
